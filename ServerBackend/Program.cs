...
namespace ServerBackend
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            jsonString = apiRequest.MakeAPIRequest("https://" + region + ".api.blizzard.com/data/wow/" + apiRequestType + "/index?namespace=" + apiRequestNamespace + "-" + region + "&locale=" + locale + "&access_token=" + blizzardAPIAuthentication.accessToken);
